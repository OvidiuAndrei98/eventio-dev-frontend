...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-[color,box-shadow] disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 [&_svg]:shrink-0 ring-slate-950/10 dark:ring-slate-950/20 dark:outline-ring/40 outline-ring/50 focus-visible:ring-0 focus-visible:outline-0 aria-invalid:focus-visible:ring-0 dark:ring-slate-300/10 dark:dark:ring-slate-300/20",
  {
    variants: {
      variant: {
        default:
