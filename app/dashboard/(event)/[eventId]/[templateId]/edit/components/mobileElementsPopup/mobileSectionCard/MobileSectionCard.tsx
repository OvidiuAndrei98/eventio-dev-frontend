...
import MobileSortableElement from './MobileSortableElement';
...
const MobileSectionCard = ({
  ...
  return (
    <>
      <div
        className={`template-editor-section-card flex items-center gap-1 w-full p-[16px_2px_0_2px] rounded hover:bg-gray-100 cursor-pointer text-sm text-gray-700 $`}
